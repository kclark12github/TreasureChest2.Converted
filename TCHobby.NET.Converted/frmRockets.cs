...
namespace TCHobby
{
	public class frmRockets : frmTCStandard
	{
		const string myFormName = "frmRockets";
		public frmRockets(clsSupport objSupport, clsRockets objBase, Form objParent = null, string Caption = null) : base(myFormName, objSupport, objBase, Caption, objParent)
		{
		...
		private void InitializeComponent()
		{
			...
			this.dtpPurchased.Location = new System.Drawing.Point(296, 248);
			...
			this.chkWishList.Location = new System.Drawing.Point(104, 220);
			...
			this.lblPurchased.Location = new System.Drawing.Point(218, 250);
			...
			this.dtpInventoried.Location = new System.Drawing.Point(296, 304);
			...
			this.lblInventoried.Location = new System.Drawing.Point(204, 306);
			...
			this.cbLocation.Location = new System.Drawing.Point(104, 276);
			...
			//lblVerified
			//
			this.lblVerified.Location = new System.Drawing.Point(236, 194);
			...
			//lblValue
			//
			this.lblValue.Location = new System.Drawing.Point(58, 194);
			...
			this.lblLocation.Location = new System.Drawing.Point(39, 279);
			...
			this.txtAlphaSort.Location = new System.Drawing.Point(552, 252);
			...
			this.lblAlphaSort.Location = new System.Drawing.Point(476, 256);
			...
			//txtPrice
			//
			this.txtPrice.Location = new System.Drawing.Point(104, 248);
			...
			this.cbAlphaSort.Location = new System.Drawing.Point(552, 252);
			...
			//lblPrice
			//
			this.lblPrice.Location = new System.Drawing.Point(63, 250);
			...
			this.lblScale.Location = new System.Drawing.Point(268, 138);
			...
			//cbScale
			//
			this.cbScale.Location = new System.Drawing.Point(316, 135);
			...
			this.lblType.Location = new System.Drawing.Point(63, 56);
			...
			this.txtDesignation.Location = new System.Drawing.Point(328, 53);
			this.txtDesignation.Name = "txtDesignation";
			this.txtDesignation.Size = new System.Drawing.Size(80, 23);
			...
			this.lblDesignation.Location = new System.Drawing.Point(240, 55);
			this.lblDesignation.Name = "lblDesignation";
			this.lblDesignation.Size = new System.Drawing.Size(84, 19);
			this.lblDesignation.TabIndex = 108;
			this.lblDesignation.Text = "Designation";
			//
			//lblCatalog
			//
			this.lblCatalog.AutoSize = true;
			this.lblCatalog.Location = new System.Drawing.Point(44, 167);
			...
			this.lblManufacturer.Location = new System.Drawing.Point(6, 111);
			...
			this.lblNation.Location = new System.Drawing.Point(52, 84);
			this.lblNation.Name = "lblNation";
			this.lblNation.Size = new System.Drawing.Size(48, 19);
			...
			this.cbNation.Size = new System.Drawing.Size(308, 24);
			...
			this.lblReference.Location = new System.Drawing.Point(32, 138);
			this.lblReference.Name = "lblReference";
			this.lblReference.Size = new System.Drawing.Size(72, 19);
			this.lblReference.TabIndex = 114;
			...
			this.Name = "frmRockets";
			this.Text = "frmRockets";
		...
		protected override void BindControls()
		{
			...
			BindControl(cbType, mTCBase.MainDataView, "Type", ((clsRockets)mTCBase).Types, "Type", "Type");
			BindControl(txtName, mTCBase.MainDataView, "Name");
			BindControl(cbScale, mTCBase.MainDataView, "Scale", ((clsRockets)mTCBase).Scales, "Scale", "Scale");
			BindControl(cbNation, mTCBase.MainDataView, "Nation", ((clsRockets)mTCBase).Nations, "Nation", "Nation");
			BindControl(cbManufacturer, mTCBase.MainDataView, "Manufacturer", ((clsRockets)mTCBase).Manufacturers, "Manufacturer", "Manufacturer");
			BindControl(cbCatalog, mTCBase.MainDataView, "ProductCatalog", ((clsRockets)mTCBase).Catalogs, "ProductCatalog", "ProductCatalog");
			...
			BindControl(cbLocation, mTCBase.MainDataView, "Location", ((clsRockets)mTCBase).Locations, "Location", "Location");
		...
		{
			const string EntryName = "frmRockets.Form_Closing";
			try {
		...
		{
			const string EntryName = "frmRockets.Form_Load";
			try {
		...
		protected override void SetCaption(object sender, CancelEventArgs e)
		{
			try {
				if ((sender != null))
					base.epBase.SetError((Control)sender, bpeNullString);
				string temp = (Information.IsDBNull(mTCBase.CurrentRow["Scale"]) ? bpeNullString : mTCBase.CurrentRow["Scale"] + " Scale; ") + (Information.IsDBNull(mTCBase.CurrentRow["Designation"]) ? bpeNullString : mTCBase.CurrentRow["Designation"] + " ") + (Information.IsDBNull(mTCBase.CurrentRow["Name"]) ? bpeNullString : mTCBase.CurrentRow["Name"]);
