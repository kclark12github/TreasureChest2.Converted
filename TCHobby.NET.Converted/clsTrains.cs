...
namespace TCHobby
{
	public class clsTrains : clsTCBase
	{
		public clsTrains(clsSupport objSupport, string ModuleName) : base(objSupport, ModuleName, "Trains")
		{
		...
		public clsTrains(System.ComponentModel.IContainer Container) : this()
		{

			//Required for Windows.Forms Class Composition Designer support
			Container.Add(this);
		}
		public clsTrains() : base()
		{
		...
		private void InitializeComponent()
		{
			...
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(clsTrains));
			//
			//niIcon
			//
		...
		public override void Load(Form objParent, string Caption)
		{
			try {
                ...
                SQLSort = "Scale, Type, Line";
                //SQLMain = "Select ID, Type, Line, Scale, Manufacturer, ProductCatalog, Reference, WishList, Location, DateInventoried, Price, DatePurchased, Value, DateVerified, Notes, Image From [Trains] Order By Scale,Type,Line;"
                SQLMain = "Select ID, Type, Line, Scale, Manufacturer, ProductCatalog, Reference, WishList, Location, DateInventoried, Price, DatePurchased, Value, DateVerified, Notes, Convert(image,Null) As [Image] From [Trains] Order By Scale, Type, Line;";
				string[] SQL = {
					SQLMain,
					"Select Distinct Manufacturer From [Trains] Order By Manufacturer;",
					"Select Distinct ProductCatalog From [Trains] Order By ProductCatalog;",
					"Select Distinct Scale From [Trains] Order By Scale;",
					"Select Distinct Type From [Trains] Order By Type;",
					"Select Distinct Location From [Trains] Order By Location;"
				};
                ...
                OnSplash("Loading frmTrains...");
				base.ActiveForm = new frmTrains(mSupport, this, mParent, mText);
				OnSplash("Complete");
			} finally {
				OnSplash(null);
			}
