...
namespace TCHobby
{
	public class clsTools : clsTCBase
	{
		public clsTools(clsSupport objSupport, string ModuleName) : base(objSupport, ModuleName, "Tools")
		{
		...
		public clsTools(System.ComponentModel.IContainer Container) : this()
		{

			//Required for Windows.Forms Class Composition Designer support
			Container.Add(this);
		}
		public clsTools() : base()
		{
		...
		private void InitializeComponent()
		{
			...
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(clsTools));
			//
			//niIcon
			//
		...
		public override void Load(Form objParent, string Caption)
		{
			try {
                ...
                SQLSort = "Manufacturer, Name";
                //SQLMain = "Select ID, Name, Manufacturer, ProductCatalog, Reference, WishList, Location, DateInventoried, Price, DatePurchased, Value, DateVerified, Notes, Image From [Tools] Order By Manufacturer,Name;"
                SQLMain = "Select ID, Name, Manufacturer, ProductCatalog, Reference, WishList, Location, DateInventoried, Price, DatePurchased, Value, DateVerified, Notes, Convert(image,Null) As [Image] From [Tools] Order By Manufacturer, Name;";
				string[] SQL = {
					SQLMain,
					"Select Distinct Manufacturer From [Tools] Order By Manufacturer;",
					"Select Distinct ProductCatalog From [Tools] Order By ProductCatalog;",
					"Select Distinct Location From [Tools] Order By Location;"
				};
				OnSplash(string.Format("Reading {0} Data...", TableName));
				MainDataSet = OpenDataSet(string.Format("{0}{1}{2}{3}", SQL));
                ...
                OnSplash("Loading frmTools...");
				base.ActiveForm = new frmTools(mSupport, this, mParent, mText);
				OnSplash("Complete");
			} finally {
				OnSplash(null);
			}
