...
namespace TCHobby
{
	public class clsRockets : clsTCBase
	{
		public clsRockets(clsSupport objSupport, string ModuleName) : base(objSupport, ModuleName, "Rockets")
		{
		...
		public clsRockets(System.ComponentModel.IContainer Container) : this()
		{
		...
		private void InitializeComponent()
		{
			...
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(clsRockets));
			//
			//niIcon
			//
		...
		public override void Load(Form objParent, string Caption)
		{
			try {
                ...
                SQLSort = "Scale, Designation, Name";
                //SQLMain = "Select ID, Designation, Name, Scale, Manufacturer, ProductCatalog, Reference, WishList, Type, Nation, Location, DateInventoried, Price, DatePurchased, Value, DateVerified, Notes, Image From [Rockets] Order By Scale,Designation,Name;"
                SQLMain = "Select ID, Designation, Name, Scale, Manufacturer, ProductCatalog, Reference, WishList, Type, Nation, Location, DateInventoried, Price, DatePurchased, Value, DateVerified, Notes, Convert(image,Null) As [Image] From [Rockets] Order By Scale, Designation, Name;";
				string[] SQL = {
					SQLMain,
					"Select Distinct Manufacturer From [Rockets] Order By Manufacturer;",
					"Select Distinct ProductCatalog From [Rockets] Order By ProductCatalog;",
					"Select Distinct Scale From [Rockets] Order By Scale;",
					"Select Distinct Nation From [Rockets] Order By Nation;",
					"Select Distinct Type From [Rockets] Order By Type;",
					"Select Distinct Location From [Rockets] Order By Location;"
				};
                ...
                OnSplash("Loading frmRockets...");
				base.ActiveForm = new frmRockets(mSupport, this, mParent, mText);
				OnSplash("Complete");
			} finally {
				OnSplash(null);
			}
