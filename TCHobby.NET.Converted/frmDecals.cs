...
namespace TCHobby
{
	public class frmDecals : frmTCStandard
	{
		const string myFormName = "frmDecals";
		public frmDecals(clsSupport objSupport, clsDecals objBase, Form objParent = null, string Caption = null) : base(myFormName, objSupport, objBase, Caption, objParent)
		{
		...
		{
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(frmDecals));
			...
			this.lblPurchased.Location = new System.Drawing.Point(224, 246);
			//
			//lblInventoried
			//
			...
			this.lblInventoried.Location = new System.Drawing.Point(204, 302);
			//
			//lblLocation
			//
			...
			this.lblLocation.Location = new System.Drawing.Point(33, 275);
			//
			//lblAlphaSort
			//
			...
			this.lblAlphaSort.Location = new System.Drawing.Point(484, 252);
			this.lblAlphaSort.Visible = false;
			//
			//lblPrice
			//
			this.lblPrice.Location = new System.Drawing.Point(57, 246);
			//
			//btnOK
			//
			...
			this.dtpPurchased.Location = new System.Drawing.Point(300, 244);
			...
			this.dtpInventoried.Location = new System.Drawing.Point(300, 300);
			...
			this.txtAlphaSort.Location = new System.Drawing.Point(580, 248);
			...
			//rtfNotes
			//
			this.rtfNotes.Size = new System.Drawing.Size(764, 462);
			...
			this.cbAlphaSort.Location = new System.Drawing.Point(580, 248);
			...
			this.gbGeneral.Size = new System.Drawing.Size(760, 347);
			...
			//lblValue
			//
			this.lblValue.Location = new System.Drawing.Point(52, 194);
			...
			//lblVerified
			//
			this.lblVerified.Location = new System.Drawing.Point(232, 194);
			...
			this.dtpVerified.Location = new System.Drawing.Point(300, 192);
			...
			this.lblNation.Location = new System.Drawing.Point(40, 84);
			...
			this.txtReference.Size = new System.Drawing.Size(140, 23);
			...
			this.lblReference.Location = new System.Drawing.Point(22, 138);
			...
			this.lblCatalog.Location = new System.Drawing.Point(38, 168);
			...
			//cbCatalog
			//
			this.cbCatalog.Location = new System.Drawing.Point(104, 164);
			...
			this.lblManufacturer.Location = new System.Drawing.Point(0, 112);
			...
			this.txtName.Size = new System.Drawing.Size(644, 23);
			...
			this.lblScale.Location = new System.Drawing.Point(276, 138);
			...
			//cbScale
			//
			this.cbScale.Location = new System.Drawing.Point(320, 135);
			...
			this.txtDesignation.Location = new System.Drawing.Point(515, 51);
			this.txtDesignation.Name = "txtDesignation";
			this.txtDesignation.Size = new System.Drawing.Size(233, 23);
			...
			this.lblDesignation.Location = new System.Drawing.Point(425, 55);
		...
		protected override void BindControls()
		{
			...
			BindControl(cbType, mTCBase.MainDataView, "Type", ((clsDecals)mTCBase).Types, "Type", "Type");
			BindControl(txtDesignation, mTCBase.MainDataView, "Designation");
			BindControl(cbNation, mTCBase.MainDataView, "Nation", ((clsDecals)mTCBase).Nations, "Nation", "Nation");
			BindControl(cbScale, mTCBase.MainDataView, "Scale", ((clsDecals)mTCBase).Scales, "Scale", "Scale");
			BindControl(cbManufacturer, mTCBase.MainDataView, "Manufacturer", ((clsDecals)mTCBase).Manufacturers, "Manufacturer", "Manufacturer");
			BindControl(cbCatalog, mTCBase.MainDataView, "ProductCatalog", ((clsDecals)mTCBase).Catalogs, "ProductCatalog", "ProductCatalog");
			...
			BindControl(cbLocation, mTCBase.MainDataView, "Location", ((clsDecals)mTCBase).Locations, "Location", "Location");
		...
		{
			const string EntryName = "frmDecals.Form_Closing";
			try {
		...
		{
			const string EntryName = "frmDecals.Form_Load";
			try {
		...
		protected override void SetCaption(object sender, CancelEventArgs e)
		{
			try {
				if ((sender != null))
					base.epBase.SetError((Control)sender, bpeNullString);
                //Me.txtCaption.Text = IIf(IsDBNull(mTCBase.CurrentRow("Sort")), bpeNullString, (string)mTCBase.CurrentRow("Sort"))
                string temp = (Information.IsDBNull(mTCBase.CurrentRow["Type"]) ? bpeNullString : (string)mTCBase.CurrentRow["Type"] + "; ") + (Information.IsDBNull(mTCBase.CurrentRow["Scale"]) ? bpeNullString : mTCBase.CurrentRow["Scale"] + " Scale; ") + (Information.IsDBNull(mTCBase.CurrentRow["Manufacturer"]) ? bpeNullString : mTCBase.CurrentRow["Manufacturer"]);
