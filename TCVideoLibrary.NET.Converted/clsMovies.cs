...
{
	public class clsMovies : clsTCBase
	{
		public clsMovies(clsSupport objSupport, string ModuleName) : base(objSupport, ModuleName, "Movies")
		{
		...
		public clsMovies(System.ComponentModel.IContainer Container) : this()
		{

			//Required for Windows.Forms Class Composition Designer support
			Container.Add(this);
		}
		public clsMovies() : base()
		{
		...
		private void InitializeComponent()
		{
			...
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(clsMovies));
			//
			//niIcon
			//
		...
		public override void Load(Form objParent, string Caption)
		{
			try {
				...
				mTableName = "Movies";
				mTableIDColumn = "ID";
				mTableKeyColumn = "Sort";
				SQLFilter = clsSupport.bpeNullString;
                SQLSort = "Sort";
                //SQLMain = "Select ID, Sort, WishList, Subject, Title, Format, WMV, ReleaseDate, Location, Distributor, DateInventoried, Value, DateVerified, StoreBought, Price, DatePurchased, Image, OtherImage, Notes From [Movies] Order By Sort;"
                SQLMain = "Select ID, Sort, WishList, Subject, Title, Format, WMV, ReleaseDate, Location, Distributor, DateInventoried, Value, DateVerified, StoreBought, Price, DatePurchased, Notes, Convert(image,Null) As [Image], Convert(image,Null) As [OtherImage] From [Movies] Order By Sort;";
				string[] SQL = {
					SQLMain,
					"Select Distinct Distributor From [Movies] Order By Distributor;",
					"Select Distinct Location From [Movies] Order By Location;",
					"Select Distinct Subject From [Movies] Order By Subject;",
					"Select Distinct Format From [Movies] Order By Format;"
				};
                ...
                OnSplash("Loading frmMovies...");
				base.ActiveForm = new frmMovies(mSupport, this, mParent, mText);
				OnSplash("Complete");
			} finally {
				OnSplash(null);
			}
